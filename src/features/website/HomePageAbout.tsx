...
export default function HomePageAbout() {
  return (
    <section className="min-h-[85vh] flex flex-col items-center justify-center">
      ...
      <div className="text-3xl md:text-4xl lg:text-6xl text-zinc-800 font-medium my-6">
        <p>Empowering you</p>
        <p>to Achieve More,</p>
        <p>Every Day</p>
      </div>
      <div className="flex flex-wrap justify-center items-stretch gap-6 font-bold text-zinc-900">
